              ...
              <Card key={offer.id} className="bg-white rounded-xl shadow-md overflow-hidden flex-shrink-0 w-full sm:w-[350px] transition-transform hover:-translate-y-1 hover:shadow-lg">
                ...
                <CardContent className="p-5">
                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      <span className="text-neutral-500 text-sm line-through">{offer.originalPrice.toLocaleString('en-US')} EGP</span>
                      <span className="text-xl font-bold text-[#2f6088] ml-2">{offer.price.toLocaleString('en-US')} EGP</span>
