...
import { MapPin, Calendar, Users, Star, Phone, Mail, Clock } from "lucide-react";
                            ...
                            <div className="space-y-2">
                              {packageData.rooms
                                ...
                                .map((room: any, roomIndex: number) => (
                                  <div key={roomIndex} className="flex items-center justify-between bg-gray-50 p-2 rounded">
                                    ...
                                    <div className="text-sm font-medium">
                                      ${Math.round(room.customPrice || room.originalPrice)}/night
                                    </div>
                                  </div>
                                ))}
                            </div>
