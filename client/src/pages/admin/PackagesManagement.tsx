                          ...
                          <div className="absolute top-0 right-0 bg-primary text-white px-4 py-2 rounded-bl-lg font-bold shadow-md">
                            {pkg.discountedPrice && pkg.discountedPrice < pkg.price ? (
                              <div className="text-right">
                                <span className="line-through text-white/70 text-sm mr-2">{pkg.price.toLocaleString('en-US')} EGP</span>
                                <span>{pkg.discountedPrice.toLocaleString('en-US')} EGP</span>
                              </div>
                            ) : (
                              <span>{pkg.price.toLocaleString('en-US')} EGP</span>
                            )}
                          </div>
