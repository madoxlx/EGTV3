...
export function PackageCreatorForm({
    ...
    if (isEditMode && existingPackageData && !isInitialized) {
      ...
      setTimeout(() => {
        ...
        console.log("📋 Package Policy Fields:", {
          cancellationPolicy:
            existingPackageData.cancellationPolicy || "NOT FOUND",
          childrenPolicy: existingPackageData.childrenPolicy || "NOT FOUND",
          termsAndConditions:
            existingPackageData.termsAndConditions || "NOT FOUND",
        ...
        console.log("🔤 Package Arabic Fields:", {
          ...
          shortDescriptionAr:
            existingPackageData.shortDescriptionAr || "NOT FOUND",
          overviewAr: existingPackageData.overviewAr || "NOT FOUND",
          bestTimeToVisitAr:
            existingPackageData.bestTimeToVisitAr || "NOT FOUND",
          cancellationPolicyAr:
            existingPackageData.cancellationPolicyAr || "NOT FOUND",
          childrenPolicyAr: existingPackageData.childrenPolicyAr || "NOT FOUND",
          termsAndConditionsAr:
            existingPackageData.termsAndConditionsAr || "NOT FOUND",
        ...
        console.log("🔤 Form Arabic Fields:", {
          ...
          cancellationPolicyAr:
            currentFormData.cancellationPolicyAr || "NOT SET",
          childrenPolicyAr: currentFormData.childrenPolicyAr || "NOT SET",
          termsAndConditionsAr:
            currentFormData.termsAndConditionsAr || "NOT SET",
          ...
          try {
            ...
            setImages((prev) => {
              ...
              const updatedGalleryUrls = updatedImages
                .filter(
                  (img) => img.preview && !img.preview.startsWith("blob:"),
                )
                .map((img) => img.preview);

              console.log(
                "📸 Updated galleryUrls after upload:",
                updatedGalleryUrls,
              );
              ...
              if (isFirstImage) {
                console.log(
                  "🖼️ Setting first uploaded image as main:",
                  serverUrl,
                );
  ...
  const setMainImage = (id: string) => {
    setImages((prev) => {
      ...
      if (
        ...
        !newMainImage.preview.startsWith("blob:")
      ) {
  ...
  const translateNextField = async (
    ...
    console.log(
      `🔄 Translating field ${index + 1}/${queue.length}: ${field.id}`,
    );
    ...
    try {
      ...
      if (translation?.trim()) {
        console.log(
          `✅ Translation successful for ${field.id}:`,
