...
export default function SettingsPage() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">{t('admin.settings.title', 'Settings')}</h1>
        <p className="text-zinc-500">{t('admin.settings.subtitle', 'Manage your account settings and preferences')}</p>
      </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        <TabsList className="grid w-full grid-cols-4 h-auto">
          ...
          >
            <User size={16} />
            <span>{t('admin.settings.profile', 'Profile')}</span>
          </TabsTrigger>
          <TabsTrigger
            value="security"
            className="flex items-center gap-2 data-[state=active]:border-b-2 data-[state=active]:border-primary py-3"
          >
            <Lock size={16} />
            <span>{t('admin.settings.security', 'Security')}</span>
          </TabsTrigger>
          <TabsTrigger
            value="notifications"
            className="flex items-center gap-2 data-[state=active]:border-b-2 data-[state=active]:border-primary py-3"
          >
            <BellRing size={16} />
            <span>{t('admin.settings.notifications', 'Notifications')}</span>
          </TabsTrigger>
          <TabsTrigger
            value="appearance"
            className="flex items-center gap-2 data-[state=active]:border-b-2 data-[state=active]:border-primary py-3"
          >
            <Palette size={16} />
            <span>{t('admin.settings.appearance', 'Appearance')}</span>
          </TabsTrigger>
        </TabsList>
