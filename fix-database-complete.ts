...
const connectionString = process.env.DATABASE_URL || "postgresql://postgres:password@localhost:5432/sahara_travel";
...
fixDatabaseComplete()
  .then(() => {
    console.log("✅ تم الانتهاء من الإصلاح الشامل لقاعدة البيانات");
    process.exit(0);
  })
  .catch((error) => {
