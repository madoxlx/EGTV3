...
export interface IStorage {
  ...
  getNationalityVisaRequirementByVisaAndNationality(visaId: number, nationalityId: number): 
Promise<NationalityVisaRequirement | undefined>;
  listNationalityVisaRequirements(visaId?: number, nationalityId?: number): 
Promise<NationalityVisaRequirement[]>;
  createNationalityVisaRequirement(requirement: InsertNationalityVisaRequirement): 
Promise<NationalityVisaRequirement>;
  updateNationalityVisaRequirement(id: number, requirement: Partial<InsertNationalityVisaRequirement>): 
Promise<NationalityVisaRequirement | undefined>;
...
Promise<NationalityVisaRequirement | undefined>;
  ...
  updateRoomCombination(id: number, combination: Partial<InsertRoomCombination>): Promise<RoomCombination 
| undefined>;
  ...
  updateTransportType(id: number, locationType: Partial<InsertTransportType>): Promise<TransportType | 
undefined>;
  ...
  updateTransportLocation(id: number, location: Partial<InsertTransportLocation>): 
Promise<TransportLocation | undefined>;
  ...
  updateTransportDuration(id: number, duration: Partial<InsertTransportDuration>): 
Promise<TransportDuration | undefined>;
  ...
  updateTransportation(id: number, transport: Partial<InsertTransportation>): Promise<Transportation | 
undefined>;
  ...
  updateSiteLanguageSettings(settings: Partial<InsertSiteLanguageSetting>): Promise<SiteLanguageSetting | 
undefined>;
  ...
  updateDictionaryEntry(id: number, entry: Partial<InsertDictionaryEntry>): Promise<DictionaryEntry | 
undefined>;
  ...
  updateHotelCategory(id: number, category: Partial<InsertHotelCategory>): Promise<HotelCategory | 
undefined>;
  ...
  updatePackageCategory(id: number, category: Partial<InsertPackageCategory>): Promise<PackageCategory | 
undefined>;
...
db.select().from(nationalityVisaRequirements).where(eq(nationalityVisaRequirements.id, id));
    return requirement;
  }

  async getNationalityVisaRequirementByVisaAndNationality(visaId: number, nationalityId: number): 
Promise<NationalityVisaRequirement | undefined> {
  ...
  async listNationalityVisaRequirements(visaId?: number, nationalityId?: number): 
Promise<NationalityVisaRequirement[]> {
  ...
  async createNationalityVisaRequirement(data: InsertNationalityVisaRequirement): 
Promise<NationalityVisaRequirement> {
    const [newRequirement] = await db.insert(nationalityVisaRequirements).values(data).returning();
    return newRequirement;
  }

  async updateNationalityVisaRequirement(id: number, data: Partial<InsertNationalityVisaRequirement>): 
Promise<NationalityVisaRequirement | undefined> {
  ...
  async updateTourCategory(id: number, category: Partial<InsertTourCategory>): Promise<TourCategory | 
undefined> {
  ...
  async updateHotelCategory(id: number, category: Partial<InsertHotelCategory>): Promise<HotelCategory | 
undefined> {
...
undefined> {
  ...
  async updatePackageCategory(id: number, category: Partial<InsertPackageCategory>): 
  ...
  private initSampleData() {
    ...
    if (this.destinations.length === 0) {
      ...
      this.destinations.push({
        ...
        country: 'Egypt',
        description: 'A beautiful resort town on the Red Sea coast, known for its stunning beaches and 
coral reefs.',
    ...
    this.transportations.push({
      ...
      typeId: 1, // Car
      description: 'Comfortable private car service from Cairo International Airport to your hotel in the 
city center.',
      ...
      passengerCapacity: 4,
      baggageCapacity: 3,
      features: ["Air conditioning", "Free Wi-Fi", "Bottled water", "Professional driver", "From Cairo 
Airport to city center"],
    ...
    this.transportations.push({
      ...
      typeId: 3, // Boat
      description: 'Scenic river transportation along the Nile with panoramic views of Cairo, from Cairo 
Nile Docks to Giza River Port.',
      destinationId: 1, // Cairo
    ...
    this.transportations.push({
      ...
      typeId: 4, // Jeep
      description: 'Exciting desert transportation with 4x4 jeeps in the Sinai Desert near Sharm El 
Sheikh. Includes pickup from hotels.',
      ...
      passengerCapacity: 6,
      baggageCapacity: 4,
      features: ["Off-road experience", "Bedouin guide", "Sunset views", "Photo stops", "4-hour 
adventure"],
      withDriver: true,
      available: true,
      pickupIncluded: true,
    ...
    this.transportations.push({
      ...
      description: 'Traditional horse carriage ride through the Siq to the Treasury at Petra. Starts at 
Petra Visitor Center.',
    ...
    this.transportations.push({
      ...
      typeId: 5, // Yacht
      description: 'Private yacht charter for exploring the Red Sea coast from Sharm El Sheikh. Full-day 
experience departing from Sharm El Sheikh Marina.',
      destinationId: 2, // Sharm El Sheikh
      ...
      passengerCapacity: 10,
      baggageCapacity: 6,
      features: ["Captain and crew", "Snorkeling equipment", "Lunch and drinks", "Music system", "Sun 
deck", "8-hour cruise"],
      withDriver: true,
      available: true,
      pickupIncluded: true,
    ...
    this.hotels.push({
      id: 2,
      name: 'MÃ¶venpick Resort Sharm El Sheikh',
    ...
    this.hotels.push({
      ...
      description: 'Overlooking the spectacular Petra Valley, this hotel combines traditional hospitality 
with modern amenities.',
    ...
    this.rooms.push({
      ...
      size: '75mÂ²',
      bedType: 'King',
      amenities: ["Free WiFi", "Air Conditioning", "Minibar", "Safe", "Flat-screen TV", "Lounge Access", 
"Butler Service"],
    ...
    this.tours.push({
      ...
      description: 'Discover the ancient wonders of Egypt with a guided tour of the Pyramids of Giza and 
the Great Sphinx. Includes comfortable private transportation and expert guides.',
...
Sphinx tour\n15:30 - Visit the Valley Temple\n16:30 - Return to hotel in comfort",
    ...
    this.tours.push({
      ...
      description: 'Explore the vibrant underwater world of the Red Sea with a full-day snorkeling trip 
from Sharm El Sheikh aboard a premium yacht with all amenities.',
...
drop-off in comfort",
    ...
    this.tours.push({
      ...
      description: 'Experience the magic of Petra illuminated by candlelight on this enchanting evening 
tour featuring traditional horse carriage transport to enhance the atmosphere.',
...
transportation to hotel",
    ...
    this.packages.push({
      ...
      description: 'Experience Cairo with this all-inclusive package that includes visa processing, 
flights, premium transportation services, and 5-star accommodation.',
      price: 1200,
      duration: 7,
    ...
    this.packages.push({
      ...
      description: 'Complete diving package with premium transportation between all activities and luxury 
beachfront accommodation.',
    ...
    this.packages.push({
      ...
      description: 'Comprehensive Jordan tour package including international flights, luxury 
transportation options, and 5-star accommodation.',
      price: 1600,
      duration: 8,
  ...
  async updateDestination(id: number, updateData: Partial<InsertDestination>): Promise<Destination | 
undefined> {
  ...
  async updateRoomCombination(id: number, combination: Partial<InsertRoomCombination>): 
Promise<RoomCombination | undefined> {
  ...
  async getTransportation(id: number): Promise<Transportation | undefined> {
    try {
      // Ø§Ø³ØªØ®Ø¯Ø§Ù… Ø§Ø³ØªØ¹Ù„Ø§Ù… Ù…Ø¨Ø³Ø· Ø¨Ø¯ÙˆÙ† Ø£Ø³Ù…Ø§Ø¡ Ù…Ø³ØªØ¹Ø§Ø±Ø©
  ...
  async updateTransportation(id: number, transport: Partial<InsertTransportation>): Promise<Transportation 
| undefined> {
  ...
  async updateTransportType(id: number, updateData: Partial<InsertTransportType>): Promise<TransportType | 
undefined> {
  ...
  async updateTransportLocation(id: number, updateData: Partial<InsertTransportLocation>): 
Promise<TransportLocation | undefined> {
  ...
  async updateTransportDuration(id: number, updateData: Partial<InsertTransportDuration>): 
Promise<TransportDuration | undefined> {
...
Promise<RoomCombination | undefined> {
  ...
  async updateTransportType(id: number, locationType: Partial<InsertTransportType>): Promise<TransportType 
| undefined> {
  ...
  async updateTransportLocation(id: number, location: Partial<InsertTransportLocation>): 
Promise<TransportLocation | undefined> {
  ...
  async updateTransportDuration(id: number, duration: Partial<InsertTransportDuration>): 
Promise<TransportDuration | undefined> {
...
undefined> {
  ...
  async updateDictionaryEntry(id: number, entry: Partial<InsertDictionaryEntry>): Promise<DictionaryEntry 
| undefined> {
  ...
  async updateSiteLanguageSettings(settings: Partial<InsertSiteLanguageSetting>): 
Promise<SiteLanguageSetting | undefined> {
