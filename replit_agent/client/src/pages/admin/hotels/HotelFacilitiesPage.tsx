...
// Form schema for hotel facilities
...
export default function HotelFacilitiesPage() {
  ...
  const apiEndpoint = "/api/admin/hotel-facilities";
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <div>
            ...
            <CardDescription>
              Create and manage facilities for your hotels. These facilities will be selectable when creating or editing hotels.
            </CardDescription>
          </div>
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm">
                        <div className="space-y-0.5">
                          ...
                          <FormDescription>
                            Show this facility in the hotel form
                          </FormDescription>
                        </div>
                        <FormControl>
                          <Switch
      ...
      <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete the facility. This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
