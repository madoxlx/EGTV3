...
echo ""
echo "===================================="
echo "🎉 Egypt Express TVL is now running!"
echo "===================================="
echo ""
echo "📱 Access URLs:"
...
echo "   Restart: pm2 restart egypt-express-tvl"
echo "   Stop: pm2 stop egypt-express-tvl"
echo "   Monitor: pm2 monit"
echo ""
echo "🛑 To stop completely: pm2 stop egypt-express-tvl && pm2 delete egypt-express-tvl"
echo ""
